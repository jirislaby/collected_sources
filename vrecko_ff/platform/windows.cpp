...
LL_ForceFeedback::LL_ForceFeedback(const char*):
...
int LL_ForceFeedback::openDevice(void)
{
...
void LL_ForceFeedback::releaseAll()
{
...
int LL_ForceFeedback::addEffect(std::string name, REFGUID guid, DIEFFECT *eff)
{
	IDirectInputEffect *DIEffect = NULL;
...
int LL_ForceFeedback::Effect::load(int really)
{
	int ret = 0;
